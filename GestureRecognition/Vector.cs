...
namespace GestureRecognition
{
    class Vector 
    {
        ...
        /// <summary>
        /// Return the square root of the norm, i.e. the length of this vector.
        /// </summary>
        ...
        public static Vector operator *(double scalar, Vector orig)
        {
            return new Vector(orig.getX() * scalar, orig.getY() * scalar, orig.getZ() * scalar);
        }
        ...
        {
            Quaternion p = new Quaternion(axis * rotation);
            Quaternion q = new Quaternion(0, this);
            return (p * q * p.conjugate()).Vector;
        ...
        /// where the angle corresponds to that of the minimum rotation required
        /// for one vector to coincide with the other.
        /// </summary>
